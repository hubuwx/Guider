...
public class mycourses extends Activity implements OnClickListener{
	...
	private void init() {
		...
		title= (TextView) findViewById(R.id.mycourses_title);
	...
	public void onClick(View v) {
		...
		case R.id.imageButton1:
			Intent intent = new Intent(mycourses.this,PersonalActivity.class);
			startActivity(intent);
			break;

		case R.id.imageButton2:
			Intent intent1 = new Intent(mycourses.this,questions.class);
